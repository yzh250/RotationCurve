...
def loglikelihood_iso_flat(params, scale, shape, vdata, ivar, mask):
    # Construct the model
    model = rot_incl_iso(shape, scale, params)
...
def loglikelihood_NFW_flat(params, scale, shape, vdata, ivar, mask):
    # Construct the model
    model = rot_incl_NFW(shape, scale, params)
    model_masked = ma.array(model, mask=mask)
    model_flat = model_masked.compressed()
...
def loglikelihood_bur_flat(params, scale, shape, vdata, ivar, mask):
    # Construct the model
    model = rot_incl_bur(shape, scale, params)
    model_masked = ma.array(model, mask=mask)
    model_flat = model_masked.compressed()
