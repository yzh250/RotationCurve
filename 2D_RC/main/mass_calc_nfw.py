...
c_mass_nfw = Table()
c_mass_nfw['galaxy_ID'] = galaxy_ID
c_mass_nfw['Mb'] = np.nan
c_mass_nfw['Md'] = np.nan
c_mass_nfw['Mh_r90'] = np.nan
c_mass_nfw['Mh_2r90'] = np.nan
c_mass_nfw['Mh_3r90'] = np.nan
c_mass_nfw['M_HI'] = np.nan
c_mass_nfw['M_HII'] = np.nan
c_mass_nfw['Mtot_r90'] = np.nan
c_mass_nfw['Mtot_2r90'] = np.nan
c_mass_nfw['Mtot_3r90'] = np.nan
c_mass_nfw['NSA_Mstar'] = stellar_mass
c_mass_nfw['Mtot_(star_HI_Hii)'] = np.nan
c_mass_nfw['M_h1'] = np.nan
c_mass_nfw['M_h2'] = np.nan
c_mass_nfw['Mtot_(star_HI_Hii)'] = np.nan
...
for i in range(len(fit_mini_nfw)):
    ...
    if np.isfinite(gal_fit[-1]) and gal_fit[-1] < 150:
        rho_0 = float(NFW_fit_mini[0])
        Rb = float(NFW_fit_mini[1])
        SigD = float(NFW_fit_mini[2])
        Rd = float(NFW_fit_mini[3])
        rho0_h = float(NFW_fit_mini[4])
        Rh = float(NFW_fit_mini[5])
        if round(rho_0) == -7 or round(rho_0) == 1\
           ...
           pass
            ...
            Mh_r90 = halo_mass_NFW(rho0_h,r90,Rh)
            Mh_2r90 = halo_mass_NFW(rho0_h,2*r90,Rh)
            Mh_3r90 = halo_mass_NFW(rho0_h,3*r90,Rh)
            ...
            c_mass_nfw['Mb'][i] = Mb
            c_mass_nfw['Md'][i] = Md
            c_mass_nfw['Mh_r90'][i] = Mh_r90
            c_mass_nfw['Mh_2r90'][i] = Mh_2r90
            c_mass_nfw['Mh_3r90'][i] = Mh_3r90
            c_mass_nfw['Mtot_r90'][i] = Mtot_r90
            c_mass_nfw['Mtot_2r90'][i] = Mtot_2r90
            c_mass_nfw['Mtot_3r90'][i] = Mtot_3r90
            c_mass_nfw['M_h1'][i] = MHI
            c_mass_nfw['M_h2'][i] = MH2
            c_mass_nfw['Mtot_(star_HI_Hii)'][i] = Mtot2
c_mass_nfw.write('mass_nfw.csv', format='ascii.csv', overwrite=True)