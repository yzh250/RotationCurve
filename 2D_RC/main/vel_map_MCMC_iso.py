...
def log_prior(params):
    ...
    logP = 0
    if 0 < rho_b < 100 and 0.000001 < Rb < 5 and 100 < SigD < 3000 and 1 < Rd < 30\
...
bad_sampler_iso.run_mcmc(pos, 1000, progress=True)
...
for i in range(ndim):
    ax = axes_iso[i]
    ax.plot(bad_samples_iso[:1000,:,i], 'k', alpha=0.3)
...
flat_bad_samples_iso = bad_samples.reshape(ns_iso*nw_iso, nd_iso)
