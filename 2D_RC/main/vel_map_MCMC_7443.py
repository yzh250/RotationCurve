...
initial_guesses = [-1, 1, 1000, 4, -3, 25, 1.1073177785029853, 0.6447036817356814, 37, 37, 0]

model_guesses = [-1, 1, 1000, 4, -3, 25]

geo_guesses = [1.1073177785029853, 0.6447036817356814, 37, 37, 0]
################################################################################
