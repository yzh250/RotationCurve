...
fit_mini_bur_name = SMOOTHNESS_MORPH_FOLDER + 'bur_mini_bad.csv'
fit_mini_bur_table = ascii.read(fit_mini_bur_name,'r')
fit_mini_bur = fit_mini_bur_table
################################################################################
...
c_bur_MCMC = Table()
c_bur_MCMC['gal_ID'] = fit_mini_bur['galaxy_ID']
c_bur_MCMC['rho0_b'] = np.nan
c_bur_MCMC['Rb'] = np.nan
...
for i in range(len(fit_mini_bur)):
    ...
    if chi2 > 3000 and chi2 <= 4000:
        ...
        c_bur_MCMC['SigD'][i] = bur_fit_MCMC[2]
        c_bur_MCMC['Rd'][i] = bur_fit_MCMC[3]
        c_bur_MCMC['rho0_h'][i] = bur_fit_MCMC[4]
        c_bur_MCMC['Rh'][i] = bur_fit_MCMC[5]
        c_bur_MCMC['incl'][i] = bur_fit_MCMC[6]
        c_bur_MCMC['phi'][i] = bur_fit_MCMC[7]
        c_bur_MCMC['x_cen'][i] = bur_fit_MCMC[8]
        c_bur_MCMC['y_cen'][i] = bur_fit_MCMC[9]
        c_bur_MCMC['Vsys'][i] = bur_fit_MCMC[10]
        c_bur_MCMC['chi2'][i] = chi2_bur_norm_MCMC
    else:
        print(gal_ID + ' good fits from minimize with physical values',flush=True)
        
c_bur_MCMC.write('bur_mcmc_high_chi2_b15.csv', format='ascii.csv', overwrite=True)
