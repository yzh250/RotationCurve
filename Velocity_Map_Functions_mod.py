...
def loglikelihood_NFW_flat(params, scale, shape, vdata_flat, inv_sigma2, mask):
...
def nloglikelihood_NFW_flat(params, scale, shape, vdata_flat, inv_sigma2, mask):
    return -loglikelihood_NFW_flat(params, scale, shape, vdata_flat, inv_sigma2, mask)
...
def loglikelihood_bur_flat(params, scale, shape, vdata_flat, inv_sigma2, mask):
...
def nloglikelihood_bur_flat(params, scale, shape, vdata_flat, inv_sigma2, mask):
    return -loglikelihood_bur_flat(params, scale, shape, vdata_flat, inv_sigma2, mask)
##############################################################################