...
# Isothermal Model
V_inf = 100
plt.plot(roh,vel_h_iso(r*1000,V_inf,r_halo*1000),color='brown',label='$V_{inf}$ = 100 km/s')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
V_inf = 200
plt.plot(roh,vel_h_iso(r*1000,V_inf,r_halo*1000),color='blue',label='$V_{inf}$ = 200 km/s')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
V_inf = 300
plt.plot(roh,vel_h_iso(r*1000,V_inf,r_halo*1000),color='green',label='$V_{inf}$ = 300 km/s')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
V_inf = 400
plt.plot(roh,vel_h_iso(r*1000,V_inf,r_halo*1000),color='red',label='$V_{inf}$ = 400 km/s')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_NFW = 3E-3
plt.plot(roh,vel_h_NFW(r*1000,rho_0_NFW,r_halo*1000),color='brown',label='$\\rho^0_{NFW}$ = 3E-3')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_NFW = 9E-3
plt.plot(roh,vel_h_NFW(r*1000,rho_0_NFW,r_halo*1000),color='blue',label='$\\rho^0_{NFW}$ = 9E-3')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_NFW = 3E-2
plt.plot(roh,vel_h_NFW(r*1000,rho_0_NFW,r_halo*1000),color='green',label='$\\rho^0_{NFW}$ = 3E-2')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_NFW = 9E-2
plt.plot(roh,vel_h_NFW(r*1000,rho_0_NFW,r_halo*1000),color='red',label='$\\rho^0_{NFW}$ = 9E-2')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_Burket = 3E-3
plt.plot(roh,vel_h_Burket(r*1000,rho_0_Burket,r_halo*1000),color='brown',label='$\\rho^0_{Burket}$ = 3E-3')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_Burket = 9E-3
plt.plot(roh,vel_h_Burket(r*1000,rho_0_Burket,r_halo*1000),color='blue',label='$\\rho^0_{Burket}$ = 9E-3')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_Burket = 3E-2
plt.plot(roh,vel_h_Burket(r*1000,rho_0_Burket,r_halo*1000),color='green',label='$\\rho^0_{Burket}$ = 3E-2')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.grid(b=True)
...
rho_0_Burket = 9E-2
plt.plot(roh,vel_h_Burket(r*1000,rho_0_Burket,r_halo*1000),color='red',label='$\\rho^0_{Burket}$ = 9E-2')
plt.xlabel('r/$R_h$')
plt.ylabel('$v_{rot}$')
plt.legend()
plt.show()
