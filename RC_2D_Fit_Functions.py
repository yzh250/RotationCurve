...
def Galaxy_Data(galaxy_ID):
    ...
    :param galaxy_ID: 'Plate-IFU'
    :return: physical properties & data of the galaxy
...
def Galaxy_Fitting(params, scale, shape, vmap, ivar):
    '''
    ...
    bestfit_iso = minimize(nloglikelihood_iso, ig_iso, args=(scale, shape, vmap, ivar),
                           method='Powell', bounds=bounds_iso)
    print('---------------------------------------------------')
    print(bestfit_iso)
    ...
    bestfit_NFW = minimize(nloglikelihood_NFW, ig_NFW, args=(scale, shape, vmap, ivar),
                           method='Powell', bounds=bounds_NFW)
    print('---------------------------------------------------')
    print(bestfit_NFW)
    ...
    bestfit_bur = minimize(nloglikelihood_bur, ig_bur, args=(scale, shape, vmap, ivar),
                           method='Powell', bounds=bounds_bur)
    print('---------------------------------------------------')
    print(bestfit_bur)

    return bestfit_iso.x, bestfit_NFW.x, bestfit_bur.x
...
def Plotting_Isothermal(ID, shape, scale, fit_solution, mask):
    ...
    :return:
    '''
    plt.imshow(ma.array(rot_incl_iso(shape, scale, fit_solution),mask=mask), origin='lower', cmap='RdBu_r')
...
def Plotting_NFW(ID, shape, scale, fit_solution, mask):
    ...
    :return:
    '''
    plt.imshow(ma.array(rot_incl_NFW(shape, scale, fit_solution),mask=mask), origin='lower', cmap='RdBu_r')
...
def Plotting_Burket(ID, shape, scale, fit_solution, mask):
    ...
    :return:
    '''
    plt.imshow(ma.array(rot_incl_bur(shape, scale, fit_solution),mask=mask), origin='lower', cmap='RdBu_r')
...
def Hessian_Calculation_Isothermal(fit_solution, scale, shape, vmap, ivar):
    ...
    print('-------------------------------------------')
    print('Hessian matrix for Isotherma')
    print(fit_err_iso)
